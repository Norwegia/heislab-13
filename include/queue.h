...
/**
 * @brief Checks whether any queued order matches the current floor and elevator direction.
 *
...
/**
 * @brief Deletes all orders that match the current floor and elevator movement direction.
 *
 * @param current_floor The floor the elevator is currently on.
 * @param state         The current state of the elevator.
 * @param queue         Pointer to the queue.
